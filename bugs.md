...
2.  Traceback (most recent call last):
  File "C:\Users\gh550414\Documents\GitHub\Hotdog-Stand\game.py", line 2, in <module>
    menu.startMenu() #does the start menu function
    ~~~~~~~~~~~~~~^^
  File "C:\Users\gh550414\Documents\GitHub\Hotdog-Stand\menu.py", line 20, in startMenu
    pricing.price(recipes.ingredients,inventory.inventory)
    ~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\gh550414\Documents\GitHub\Hotdog-Stand\pricing.py", line 25, in price
    print(f"Total profit per hotdog: {float(pricePer)-costPer}")
                                      ~~~~~^^^^^^^^^^
OverflowError: int too large to convert to float

desc. I can't make africa go bankrupt from buying 1 hotdog